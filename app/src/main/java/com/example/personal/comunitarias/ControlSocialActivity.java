...
import com.example.personal.comunitarias.ControlSocial.CUFragment;
import com.example.personal.comunitarias.ControlSocial.DCFragment;
import com.example.personal.comunitarias.ControlSocial.OFragment;
import com.example.personal.comunitarias.ControlSocial.VCFragment;
...
public class ControlSocialActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return "VEEDURÍAS CIUDADANAS";
                case 1:
                    return "OBSERVATORIOS";
                case 2:
                    return "DEFENSORÍAS COMUNITARIAS";
                case 3:
                    return "COMITÉS DE USUARIOS";
            }
            return null;
        }
    }
